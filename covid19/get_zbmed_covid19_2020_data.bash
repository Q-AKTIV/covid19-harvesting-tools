...
curl "http://z3950.zbmed.de:6210/livivo?version=2.0?operation=searchRetrieve&query=dc.subject=covid19%20AND%20dc.date=2020&facetLimit=0&startRecord=[1-70000:5000]&recordSchema=xml&x-username=zbmintern&maximumRecords=5000" -o "2020-07-02-COVID19-2020-#1.xml"
